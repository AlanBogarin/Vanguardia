...
const TABLAS = {
    ...
    CUENTA_POR_PAGAR: [
        ...
        { data: "installments", title: "Cantidad Cuotas", render: renderNumber },
        { data: "installment_type", title: "Frecuencia Cuotas", render: renderString },
    ...
    CUOTA_POR_PAGAR: [
        { data: "id", title: "Id Cuota", render: renderRaw },
        { data: "account_payable_id", title: "Id Cuenta", render: renderRaw },
        { data: "installment_number", title: "Número Cuota", render: renderNumber },
        { data: "amount", title: "Importe", render: renderMoneda },
        { data: "amount_paid", title: "Monto abonado", render: renderMoneda },
        { data: "status", title: "Estado", render: renderString },
        { data: "due_date", title: "Fecha Vencimiento", render: renderFecha },
        { data: "created_at", title: "Fecha Creación", render: renderFecha },
        { data: "updated_at", title: "Fecha Modificación", render: renderFecha }
    ],
    CUOTA_POR_COBRAR: [
